...
export default function DisplaySection({ locale }: { locale?: string }) {
  ...
  const programs: DisplayProgram[] = [
    {
      ...
      subKo: "진입형 매대",
      subEn: "Starter Fixture",
      descKo: "K-Beauty를 처음 도입하거나 매장의 한정된 유휴 공간에서 고객 반응 및 시장성을 빠르게 테스트하기 위한 핵심 집중형 구성.",
      descEn: "Designed for stores launching K-Beauty for the first time or testing customer demand within a compact footprint.",
    ...
    },
    {
      ...
      subKo: "성장형 매대",
      subEn: "Growth Fixture",
      descKo: "카테고리와 SKU 진열폭을 대폭 넓혀 본격적인 매장 내 K-Beauty 목적 구매 유입과 카테고리 매출 성장을 이끄는 2열 모듈 구성.",
      descEn: "Expands category width and SKU selections, driving dedicated beauty shopper foot traffic and category revenue growth.",
    ...
    },
    {
      ...
      subKo: "데스티네이션 매대",
      subEn: "Destination Fixture",
      descKo: "여러 스킨케어, 헤어케어, 메이크업 브랜드를 아울러 폭넓은 풀 라인업 쇼핑 가이드를 제공하는 완성형 모듈러 리테일 인프라 시스템.",
      descEn: "Create a complete, high-impact beauty department offering full assortments across skincare, hair care, and cosmetics.",
  ...
  return (
    <section
      id="display"
      className="w-full bg-[#141414] border-y border-[#2a2a2a] py-[120px] text-left select-none font-sans font-medium"
    >
      <div className="max-w-[1400px] mx-auto px-[32px] sm:px-[64px] flex flex-col gap-12">
        
        {/* ================= HEADER SECTION ================= */}
        <div className="max-w-[760px] flex flex-col gap-3">
          <span className="text-[11px] font-black text-[#ff2b75] tracking-[0.08em] uppercase font-display">
            03B — K-BEAUTY CATEGORY DISPLAY
          </span>
          <h2 className="font-display text-3xl sm:text-[38px] font-bold leading-[1.2] text-white tracking-tight keep-all">
            {isKo ? (
              <>매장 안에, 하나의 완성된 K-Beauty 카테고리를 만듭니다.</>
            ) : (
          ...
          <p className="text-[13.5px] text-[#9ca3af] leading-relaxed font-medium mt-1">
            {isKo 
              ? "매장 규모와 고객 특성에 맞춰 4FT, 8FT, 12FT 모듈형 디스플레이를 구성합니다. 단순한 진열장이 아니라, 큐레이션된 상품부터 가격·제품 정보·구매 가이드까지 하나의 시스템으로 설계된 K-Beauty 전문 B2B 리테일 인프라입니다."
              : "We configure 4FT, 8FT, or 12FT modular backlit LED displays to match your store size and layout. This is not just shelving; it is a turnkey infrastructure designed to maximize sales per square foot."
            }
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-[0.45fr_0.55fr] gap-12 items-stretch mt-2">
          ...
          <div className="flex flex-col justify-between gap-8">
            ...
            <div className="flex flex-col gap-5">
              ...
              <div className="bg-[#0c0c0c]/40 border border-white/5 rounded-[16px] p-6 text-left flex flex-col gap-2.5 min-h-[160px] justify-center animate-fade-in">
                <div className="flex items-center justify-between">
                  <span className="text-[11px] font-black text-[#ff2b75] tracking-widest uppercase font-display">
                    {activeProg.tag}
                  </span>
                  <span className="text-[9.5px] text-[#7A7A7A] font-bold uppercase tracking-wider bg-white/5 border border-white/10 px-2 py-0.5 rounded-[4px] font-display">
                    {isKo ? activeProg.subKo : activeProg.subEn}
                  </span>
                </div>
                <h3 className="text-xl font-bold text-white tracking-tight">
                  {isKo ? activeProg.titleKo : activeProg.titleEn}
                </h3>
                <p className="text-[12.5px] text-[#9ca3af] leading-relaxed font-medium">
                  {isKo ? activeProg.descKo : activeProg.descEn}
                </p>
              </div>

            </div>

            {/* Middle: 4 Value Points */}
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="border border-white/5 bg-[#0c0c0c]/20 p-4.5 rounded-[14px] text-left">
                ...
                <p className="text-[10px] text-[#7A7A7A] leading-normal font-semibold">
                  {isKo ? "매장 환경에 맞게 4FT부터 12FT까지 규격 유연 확장 지원" : "Flexible expansion from 4FT to 12FT to fit your floor layout."}
                </p>
              </div>
              ...
              <div className="border border-white/5 bg-[#0c0c0c]/20 p-4.5 rounded-[14px] text-left">
                ...
                <p className="text-[10px] text-[#7A7A7A] leading-normal font-semibold">
                  {isKo ? "전문가의 검토와 테스트를 통과한 최적의 상품 큐레이션" : "High-turn skincare and haircare SKUs curated for your store."}
                </p>
              </div>
              ...
              <div className="border border-white/5 bg-[#0c0c0c]/20 p-4.5 rounded-[14px] text-left">
                ...
                <p className="text-[10px] text-[#7A7A7A] leading-normal font-semibold">
                  {isKo ? "제품 용도와 피부고민별 직관적인 리테일 안내 스트립" : "Intuitive shelf talkers explaining product usage and benefits."}
                </p>
              </div>
              ...
              <div className="border border-[#ff2b75]/30 bg-[#ff2b75]/5 p-4.5 rounded-[14px] text-left shadow-[0_0_15px_rgba(255,43,117,0.03)]">
                ...
                <p className="text-[10px] text-[#ff2b75] leading-normal font-semibold">
                  {isKo 
                    ...
                    : "Allows self-guided shopping; customers scan QR codes to view ingredient details and benefits."
                  }
                </p>
              </div>
            ...
            <div className="border border-white/10 bg-[#0c0c0c] rounded-[16px] p-6 text-left flex flex-col gap-2">
              <span className="text-[10px] text-[#ff2b75] tracking-widest font-black uppercase block font-display">
              ...
              <p className="text-[11px] text-[#9ca3af] leading-relaxed font-medium">
                {isKo ? (
                  ...
                  <>
                    Shoppers can understand, explore, and choose with confidence through pricing and QR-guided information, even without dedicated beauty consultants.
                  </>
                )}
              </p>
            </div>
          ...
          <div className="bg-[#0c0c0c] border border-white/10 rounded-[24px] shadow-2xl p-6 sm:p-8 flex flex-col items-center justify-center min-h-[560px] sm:min-h-[660px] relative overflow-hidden group">
              ...
              {programs.map((p) => (
                ...
                >
                  <div className="relative w-full h-full">
                    <Image
                      src={p.image}
                      alt={`K-Beauty ${p.id.toUpperCase()} modular retail fixture`}
                      fill
            ...
            {/* Bottom hint label */}
            <span className="text-[9.5px] text-[#7A7A7A] font-bold tracking-widest uppercase mt-4 block relative z-20 font-display">
              {isKo 
                ? "* 리테일 파트너에게 실제로 무상 대여 제공될 실물 디스플레이 가구 비율 규격"
                : "* Visual scale of actual rent-free displays provided to retail partners."
              }
            </span>
