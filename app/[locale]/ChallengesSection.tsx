...
export default function ChallengesSection() {
  ...
  return (
    <section
      id="problems-section"
      ref={sectionRef}
      className="bg-[#0c0c0c] border-y border-[#2a2a2a] relative overflow-hidden"
    >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-6 lg:gap-5 mb-12 relative">
          ...
          >
            <div className="flex justify-between items-center">
              ...
              {/* Price Tag + Exchange Arrows SVG Icon */}
            ...
            <div className="flex flex-col gap-2">
              <h4 className="text-sm font-bold text-white min-h-[40px] flex items-center">
          ...
          {/* CARD 05 - MARGIN PRESSURE (Highlighted Conclusion Card) */}
          <div 
          ...
          >
            <div className="flex justify-between items-center">
              ...
              {/* Bar Chart + Percentage Coin SVG Icon */}
            ...
            <div className="flex flex-col gap-2">
              <h4 className="text-sm font-bold text-accent min-h-[40px] flex items-center">
